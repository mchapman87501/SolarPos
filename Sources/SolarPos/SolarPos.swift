...
public struct SolarPos {
     ...
     *   - location: observer geographical latitude, longitude, and elevation (above mean sea level?), degrees and meters
        ...
        obliquityOfEcliptic: Double) -> Double
    {
        ...
        let m = oneRev(poly(coeffs: [280.4664567, 360007.6982779, 0.03032028, 1.0/49931.0, -1.0/15300.0, -1/2000000.0], x: jme))
