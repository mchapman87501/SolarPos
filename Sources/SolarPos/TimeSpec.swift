// Represents a local time of interest.  TODO: Use Foundation classes
public struct TimeSpec {
    ...
    public init(year: Int, month: UInt, day: UInt, 
         hour: UInt, minute: UInt, second: UInt, 
         gmtOffset: Int = 0, deltaT: Double = 0.0)
    {
        // TODO Validation of month, day, hour, etc.
        self.year = year
        self.month = month
        self.day = day
        self.hour = hour
    ...
    public func toStr() -> String {
        // TimeSpec's GMT offset is in whole hours rather than hours + minutes.
        // hence this.
        return String(format: "%04d/%02d/%02d %02d:%02d:%02d %+03d00", year, month, day, hour, minute, second, gmtOffset)
    }
}
